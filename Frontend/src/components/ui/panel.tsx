...
export function Panel({
  ...
  return (
    <section className={cn("overflow-hidden rounded-[24px] border border-[#FF7138]/30 bg-white shadow-[0_4px_25px_rgba(0,0,0,0.06)] transition-all duration-200 hover:border-[#FF7138]", className)}>
      <div className="flex items-center justify-between gap-3 border-b border-[#FF7138]/20 bg-[#F6F6F2]/60 px-6 py-4">
