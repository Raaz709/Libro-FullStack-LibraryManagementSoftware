...
public class EmailTemplatesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        return Ok(ApiResponse<IEnumerable<EmailTemplate>>.SuccessResponse(
            templates,
    ...
    public async Task<IActionResult> GetById(int id)
    {
        ...
        return Ok(ApiResponse<EmailTemplate>.SuccessResponse(
            template,
    ...
    public async Task<IActionResult> Create([FromBody] EmailTemplate template)
    {
        ...
        return CreatedAtAction(
            nameof(GetById),
            new { id },
            ApiResponse<EmailTemplate>.SuccessResponse(
                template,
