...
public class BookCopiesController : ControllerBase
{
    ...
    // All authenticated users can view book copies
    [HttpGet]
    public async Task<IActionResult> GetAll()
    {
        var copies = await _bookCopyService.GetAllAsync();

        return Ok(ApiResponse<IEnumerable<BookCopy>>.SuccessResponse(
            copies,
            "Book copies retrieved successfully."
        ));
    }

    // All authenticated users can view a book copy
    [HttpGet("{id:int}")]
    public async Task<IActionResult> GetById(int id)
    {
        ...
        return Ok(ApiResponse<BookCopy>.SuccessResponse(
            copy,
            "Book copy retrieved successfully."
        ));
    }

    // All authenticated users can view copies for a book
    ...
    // Only Librarian and Admin can create book copies
    [HttpPost]
    ...
    public async Task<IActionResult> Create([FromBody] BookCopy bookCopy)
    {
        ...
        return CreatedAtAction(
            nameof(GetById),
            new { id },
            ApiResponse<BookCopy>.SuccessResponse(
                bookCopy,
    ...
    // Only Librarian and Admin can update book copies
    [HttpPut("{id:int}")]
    [Authorize(Roles = "Librarian,Admin")]
    public async Task<IActionResult> Update(
        int id,
        [FromBody] BookCopy bookCopy)
    {
        bookCopy.Id = id;
    ...
    // Only Librarian and Admin can delete book copies
    [HttpDelete("{id:int}")]
    [Authorize(Roles = "Librarian,Admin")]
