...
//
// IMPORTANT:
// The frontend sends requests with credentials
// (withCredentials: true).
//
// Therefore AllowAnyOrigin() CANNOT be used together
// with AllowCredentials().
//
// We explicitly allow the deployed Vercel frontend,
// plus the local development origins.
// ============================================================
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowFrontend", policy =>
    {
        policy
            .WithOrigins(
                "https://libro-ozwd4a1u4-raaz14.vercel.app",
...
// IMPORTANT:
// Use AllowFrontend instead of AllowAll.
// This fixes the credentials + wildcard CORS error.
